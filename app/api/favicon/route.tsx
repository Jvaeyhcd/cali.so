...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://jvaeyhcd.fun/favicons/zolplay.png',
  '(?:github.com)': 'https://jvaeyhcd.fun/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://jvaeyhcd.fun/favicons/twitter.png',
  'coolshell.cn': 'https://jvaeyhcd.fun/favicons/coolshell.png',
  'vercel.com': 'https://jvaeyhcd.fun/favicons/vercel.png',
  'nextjs.org': 'https://jvaeyhcd.fun/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://jvaeyhcd.fun/favicon_blank.png'
